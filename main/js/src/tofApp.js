...
com.hiyoko.tofclient.App = function(tof, opt_base) {
	tof.isVisitor(function(isVisitor) {
		tof.getServerInfo(function(serverInfo){
			...
			this.chat = new com.hiyoko.tofclient.Chat(tof, interval, serverInfo, {visitor: isVisitor, html:$("#tofChat-chat"), silent: isSilentMode});
			this.map = new com.hiyoko.tofclient.Map(tof, interval, serverInfo, {isDraggable: true, html:$("#tofChat-map"), debug:getParam("debug", false)});
